...
class PDFViewer extends StatefulWidget {
  ...
  PDFViewer({super.key, required this.docId, required this.signName});
...
/////////////////////////////////////////////////////////
  void _showSignatureDialog(BuildContext context, bool signatured) {
    showDialog(
      context: context,
                ...
                child: Row(
                  ...
                  children: [
                    MaterialButton(
                      ...
                      onPressed: () {
                        _showSignatureDialog(context, signat);
                      },
                    ),
                    SizedBox(
                      width: 20,
